...
export default function PatientSearch() {
  ...
  const loadApplicationEntities = useCallback(async () => {
    try {
      ...
      if (webapps && webapps.length > 0) {
        const firstName = typeof webapps[0] === 'string' ? webapps[0] : webapps[0].curalinkWebAppName;
  ...
  const appEntityOptions = useMemo(
    () => applicationEntities.map((app, idx) => {
      const name = typeof app === 'string' ? app : app.curalinkWebAppName;
  ...
  return ( 
    <div className=" wallpaper-page w-full bg-white/50  rounded-2xl  backdrop-blur-md border shadow" >
      ...
      <div className="flex gap-2 px-6 py-3 border-b">
        ...
        <h2 className="text-2xl  mt-2  font-semibold font-[montserrat] text-gray-800">Patients</h2>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <label className=" right-3 top-2 flex items-center text-sm text-slate-500">
                  <input
                    type="checkbox"
                    name="fuzzyMatching"
            ...
            {/* Patient's Sex */}
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 border rounded-lg outline-none focus:ring-2 focus:ring-[#00768317]-500 bg-[#00768317] text-gray-800"
                >
