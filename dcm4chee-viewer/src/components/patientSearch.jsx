        ...
        <div className="flex gap-2 px-6 py-3 border-b">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mx-auto mb-6">
                <form onSubmit={handleSubmit}>
                    ...
                    className="w-full md:w-auto px-8 py-3 bg-slate-800 text-white rounded-lg hover:bg-slate-900 transition disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <table className="w-full">
                        ...
                        {searchResults.map((patient) => (
                            ...
                            <td className="px-6 py-4 text-sm text-slate-600">{patient.sex}</td>
                            <td className="px-6 py-4 text-sm text-slate-600">{patient.birthDate}</td>
                            <td className="px-6 py-4 text-sm text-slate-600">
                                <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded">
                                {patient.studies} studies
                                </span>
                            </td>
                            <td className="px-6 py-4 text-sm text-slate-600">{patient.issuer}</td>
